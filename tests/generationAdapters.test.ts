...
describe('Generation Adapters', () => {
  ...
  describe('MockGenerator', () => {
    ...
    it('should include user name and profession in description', async () => {
      ...
      expect(result.description).toContain('Ingenier@');
    });
  ...
  describe('OpenAIAdapter', () => {
    ...
    it('should validate API key before making requests', async () => {
      ...
      await expect(adapter.generate(genParams)).rejects.toThrow('API key no configurada');
    });
    ...
    it('should handle API error responses', async () => {
      ...
      await expect(adapter.generate(genParams)).rejects.toThrow('API key inválida');
    });
    ...
    it('should handle rate limit errors', async () => {
      ...
      await expect(adapter.generate(genParams)).rejects.toThrow('Límite de rate');
    });
    ...
    it('should handle server errors', async () => {
      ...
      await expect(adapter.generate(genParams)).rejects.toThrow('Error del servidor');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(adapter.generate(genParams)).rejects.toThrow('Error desconocido');
    });
