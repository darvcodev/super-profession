...
describe('PromptBuilder', () => {
  describe('buildImagePrompt', () => {
    it('should build image prompt for standard profession', () => {
      ...
      expect(prompt).toContain('Ingenier@');
  ...
  describe('buildTextPrompt', () => {
    it('should build text prompt with name and profession', () => {
      const prompt = buildTextPrompt('Ana Martín', 'Médic@');
      
      expect(prompt).toContain('Ana Martín');
      expect(prompt).toContain('Médic@');
  ...
  describe('buildWhatsAppMessage', () => {
    it('should create properly formatted WhatsApp message', () => {
      ...
      expect(message).toContain('Profesión: Arquitect@');
  ...
  describe('validatePromptParams', () => {
    it('should validate correct parameters', () => {
      const result = validatePromptParams('María González', 'Ingenier@');
    ...
    it('should reject empty name', () => {
      const result = validatePromptParams('', 'Ingenier@');
    ...
    it('should reject short name', () => {
      const result = validatePromptParams('A', 'Ingenier@');
    ...
    it('should reject long name', () => {
      ...
      const result = validatePromptParams(longName, 'Ingenier@');
  ...
  describe('getProfessionConfig', () => {
    it('should return config for standard profession', () => {
      const config = getProfessionConfig('Médic@');
      
      expect(config.value).toBe('Médic@');
      expect(config.label).toBe('Médic@');
